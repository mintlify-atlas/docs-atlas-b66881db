---
title: "XMage: Free Open-Source Magic: The Gathering Engine"
...
<CardGroup cols={2}>
  ...
  <Card title="Installation & Requirements" icon="download" href="/installation/requirements">
    System requirements, JVM tuning flags, and platform-specific setup notes.
  </Card>
  <Card title="Game Modes" icon="dice" href="/playing/game-modes">
    Explore all supported formats — from standard duels to 10-player Commander pods.
  </Card>
  <Card title="Development Setup" icon="code" href="/development/environment-setup">
