---
title: "XMage Maven Repository Layout and Module Reference"
sidebarTitle: "Project Structure"
description: "Understand the XMage Maven multi-module layout: game engine, client, server, card sets, plugins, tests, and developer utility scripts."
---
