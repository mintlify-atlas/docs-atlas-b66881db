...
description: "Learn the XMage contribution workflow: fork the repository, create a branch, implement your change, run tests with mvn test, and open a pull request."
---
